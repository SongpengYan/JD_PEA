...
#################################################################
#################################################################
JD_POS_USER = JD_POS_USER[Category == 'Fem'| Category == 'Fabric'| Category == 'Prestige']
#################################################################
#################################################################
#################################################################
#################################################################
...
cl <- makeCluster(getOption('cl.cores', 3)) # 初始化3核心集群
...
rm(JD_POS_USER)
system.time({parLapply(cl, c('Fem', 'Fabric', 'Prestige'), FCT)})
stopCluster(cl)